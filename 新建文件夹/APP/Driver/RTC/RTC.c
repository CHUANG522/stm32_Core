...
/**
 * @brief  RTC初始化
 * @note   自动尝试LSE，失败则切LSI，使用BKP0标记状态
 * @retval 0=成功, 1=时钟源失败, 2=初始化失败
 */
...
/**
 * @brief  统一设置日期和时间（避免分开设置互相覆盖）
 * @retval 0=成功, 1=参数非法, 2=硬件错误
 */
